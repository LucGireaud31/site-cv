      ...
      <ProjectContent
        ...
        body={
          <Text color="white">
            ...
            <br />
            Pour{" "}
            <Highlight color="theme.100">
              partager ses données personnelles
            </Highlight>
            , il est possible de générer un Qr Code qui sera scanné par le
            destinataire.
          </Text>
        }
        footer={
      ...
      <ProjectContent
        ...
        body={
          <Text color="white">
            ...
            <Highlight color="theme.100">APSIO</Highlight>. Un professeur peut
            faire l'appel de sa classe afin que les élèves présents soient
            récompensés en APSIO-Coin.
            <br />
            <br />
            Développée en 2021-2022 par{" "}
            <Highlight color="theme.100">Luc Gireaud</Highlight> lors d'un
            mémoire de la license professionnelle APSIO, cette{" "}
            <Highlight color="theme.100">blockchain</Highlight> vise à améliorer
            le système scolaire en rémunérant les étudiants assidus.
          </Text>
        }
        footer={
          <HStack spacing="30px">
            ...
            />
            <WebLink
              href="/documents/APSIO_Coin_et_Blockchain.pdf"
  ...
  return (
    <Box>
      <MultiScrollCards
        ...
        offset={98}
      />
      <Heading textAlign="center" mb="60px" color="theme.100">
        Bientôt le vôtre...
      </Heading>
    </Box>
  );
